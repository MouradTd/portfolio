...
export const DATA = {
  ...
  summary:
    "As a full-stack developer based in Rabat, Morocco. My skill set includes PHP, Laravel, Symfony, Node.js, SQL Server, MySQL, MongoDB, Java, Python, Git, Docker, and Postman. I’ve developed and maintained ERP applications using Laravel and Vue.js, focusing on creating robust APIs, ensuring seamless communication between the frontend and backend, and upholding high standards of code quality, security, and reliability. I’ve also contributed to web development projects using Symfony and AngularJS.",
  avatarUrl: "/logo.png",
  skills: [
    "VueJS",
    "React.js",
  ...
  work: [
    {
      ...
      description:
        "Develop and maintain an ERP application using Laravel and Vue.js technologies, creating robust API access points, conducting thorough tests for reliability and functionality, and ensuring compliance with codage standards and security protocols.",
    },
    {
      company: "Proxisoft",
      badges: [],
      ...
      location: "On Site",
      title: "Intern Developpeur Full Stack",
      logoUrl: "/proxisoft.png",
      start: "May 2023",
      end: "Aug 2023",
      description:
        "At Proxisoft, I played a significant role in the team, actively engaging in various tasks and projects. I was particularly involved in a project where we developed an application using Symfony and AngularJS. My contributions helped the team achieve its objectives, and I collaborated closely with others to ensure the project's success.",
    },
    {
      company: "ONSSA",
      badges: [],
      ...
      description:
        "During my time at ONSSA, I designed and developed a stock management application aimed at tracking products and automating supply chain actions, including inter-store transfers. I implemented a system to trace product locations and monitor their consumption status, ensuring efficient stock management and streamlined operations.",
    },
